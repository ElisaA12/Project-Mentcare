...
public class TestRegistrazionePazienteNonValidaUsername extends BaseTest {

    @Test
    public void testRegistrazionePazienteNonValidaUsername() throws ParseException {
        setUpRepository();
        ...
        String codFiscale = "ACRTTE98L61B256P";
        String nome = "Giulio";
        String cognome = "Cappelletti";
        String username= "pazienteNonAuto";
        ...
        assertEquals("Username già presente.", titleMessageErrore);
