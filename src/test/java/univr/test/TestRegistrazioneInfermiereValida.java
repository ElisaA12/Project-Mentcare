...
public class TestRegistrazioneInfermiereValida extends BaseTest {

    @Test
    public void testRegistrazioneInfermiereValida () {
        ...
        String codFiscale = "CFRTTE98L61B256T";
        String nome = "Giulio";
        String cognome = "Cappelletti";
        String username= "infermiere1";
        ...
        WebElement newRuolo = driver.findElement(By.xpath("//input[@value='Infermiere']"));
