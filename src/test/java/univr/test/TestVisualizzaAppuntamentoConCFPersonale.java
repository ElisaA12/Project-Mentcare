...
public class TestVisualizzaAppuntamentoConCFPersonale extends BaseTest {

    @Test
    public void testValidAppuntamentoCFPersonale() throws ParseException {
        setUpRepository();
