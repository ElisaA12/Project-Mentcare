...
public class TestInserimentoFarmavoNonValitoIdFarmacoDuplicatoPerPaziente extends BaseTest {

    @Test
    public void testValidInsertDrugs() throws ParseException {
        setUpRepository();
        ...
        assertEquals("Id Farmaco già presente.", titleMessageSuccesso);
