...
public class TestRegistrazioneReceptionistValida extends BaseTest {

    @Test
    public void testRegistrazioneReceptionistValida() {
        ...
        String codFiscale = "CFRTTE98L61B244R";
        String nome = "Elisa";
        String cognome = "Acciari";
        String username= "receptionist1";
        ...
        WebElement newRuolo = driver.findElement(By.xpath("//input[@value='Receptionist']"));
