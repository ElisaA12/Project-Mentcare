...
public class TestVisualizzaAppuntamentoPersonaleNonPresente extends BaseTest {
    @Test
    public void testInserimentoAppuntamentoPersonaleNonPresente() throws ParseException {
        setUpRepository();
        ...
        String codFiscalePersonale = "CFRTTE98L61B258L";
