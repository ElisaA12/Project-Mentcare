...
public class TestRegistrazionePersonaleNonValidaCodFiscale  extends BaseTest {

    @Test
    public void testRegistrazionePersonaleNonValidaCodFiscale() throws ParseException {
        setUpRepository();
        ...
        String codFiscale = "ACRTTE98L61B256M";
        String nome = "Elisa";
        ...
        assertEquals("Codice fiscale già presente.", titleMessageSuccesso);
        resetRepository();
    }
