...
public class TestRegistrazionePersonaleValida extends BaseTest {

    @Test
    public void testRegistrazionePersonaleValida() {
        ...
        String codFiscale = "CFRTTE98L61B232M";
        String nome = "Elisa";
        String cognome = "Acciari";
        String username= "medico1";
